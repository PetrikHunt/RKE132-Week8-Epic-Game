string folderPath = @"C:\Users\Petrik\Desktop\data\";
...
//string[] heroes = {"Buttercup", "Bubbles", "Blossom", "Professor Utonium"};
//string[] villians = {"Mojo Jojo", "Boogie man", "Mart Helme", "Kalle Grüntal", "Martin Helme"};
//string[] weapon = { "scimitar", "long sword", "whip", "scythe", "warhammer" };
